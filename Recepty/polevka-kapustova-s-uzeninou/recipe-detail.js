const DATA_URL=document.body.dataset.recipeSource||'./zapecene-brambory-s-kurecim-masem-a-besamelem.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:zapecene-brambory-s-kurecim-masem-a-besamelem';
