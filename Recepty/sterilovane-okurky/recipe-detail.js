const DATA_URL=document.body.dataset.recipeSource||'./sterilovane-okurky.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:sterilovane-okurky';
