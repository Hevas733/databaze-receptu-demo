const DATA_URL=document.body.dataset.recipeSource||'./kureci-rizek-smazeny.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kureci-rizek-smazeny';
