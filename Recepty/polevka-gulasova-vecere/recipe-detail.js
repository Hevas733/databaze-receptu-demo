const DATA_URL=document.body.dataset.recipeSource||'./polevka-gulasova-vecere.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:polevka-gulasova-vecere';
