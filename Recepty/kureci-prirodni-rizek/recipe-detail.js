const DATA_URL=document.body.dataset.recipeSource||'./kureci-prirodni-rizek.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kureci-prirodni-rizek';
