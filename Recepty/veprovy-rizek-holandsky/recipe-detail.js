const DATA_URL=document.body.dataset.recipeSource||'./veprovy-rizek-holandsky.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:veprovy-rizek-holandsky';
