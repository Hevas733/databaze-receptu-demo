const DATA_URL=document.body.dataset.recipeSource||'./kremova-kureci-polevka.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kremova-kureci-polevka';
