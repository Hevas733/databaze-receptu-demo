const DATA_URL=document.body.dataset.recipeSource||'./kureci-stehna-uzena.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kureci-stehna-uzena';
