const DATA_URL=document.body.dataset.recipeSource||'./kureci-rolada-plnena-vejci-hraskem-a-sunkou.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kureci-rolada-plnena-vejci-hraskem-a-sunkou';
...
function render(){
  ...
  document.querySelector('#instructions').textContent=recipe.instructions||'Příprava se na přání uživatele neřeší.';
  renderHistory();
}
