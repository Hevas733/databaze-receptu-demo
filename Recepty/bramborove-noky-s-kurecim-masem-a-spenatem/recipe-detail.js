const DATA_URL=document.body.dataset.recipeSource||'./bramborove-noky-s-kurecim-masem-a-spenatem.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:bramborove-noky-s-kurecim-masem-a-spenatem';
