const DATA_URL=document.body.dataset.recipeSource||'./kureci-zavitek-s-nivou-a-slaninou.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kureci-zavitek-s-nivou-a-slaninou';
