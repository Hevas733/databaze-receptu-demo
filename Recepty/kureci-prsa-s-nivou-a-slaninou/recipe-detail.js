const DATA_URL=document.body.dataset.recipeSource||'./kureci-prsa-s-nivou-a-slaninou.json';
const STORAGE_KEY=document.body.dataset.storageKey||'receptar:kureci-prsa-s-nivou-a-slaninou';
